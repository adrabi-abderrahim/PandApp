...
fun VirtualContactItem(virtualPeer: VirtualPeerModel, navController: NavController){
    Row(modifier = Modifier
        ...
        Icon(virtualPeer.icon, contentDescription = null, modifier = Modifier.size(64.dp), tint = Color.DarkGray)
        Column(modifier = Modifier.padding(horizontal = 8.dp)) {
            ...
            Row(verticalAlignment = Alignment.CenterVertically){
                Icon(Icons.Default.Check, modifier = Modifier.size(16.dp), tint = Color.Green , contentDescription = null)
                Spacer(modifier = Modifier.width(8.dp))
                Text(text = virtualPeer.lastMessage, maxLines = 1, fontSize = 15.sp, color = Color.Gray)
            }
